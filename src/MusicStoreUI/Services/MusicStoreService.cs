...
namespace MusicStoreUI.Services
{
    public class MusicStoreService : BaseDiscoveryService, IMusicStore
    {
		...
		private const string TOP_SELLING_URL = "https://musicstore-sa.cfapps.io/api/Store/TopSelling";
		private const string GENRES_URL = "https://musicstore-sa.cfapps.io/api/Store/Genres";
		private const string GENRE_URL = "https://musicstore-sa.cfapps.io/api/Store/Genre";
		private const string ALBUMS_URL = "https://musicstore-sa.cfapps.io/api/Store/Albums";
		private const string ALBUM_URL = "https://musicstore-sa.cfapps.io/api/Store/Album";
		private const string ARTISTS_URL = "https://musicstore-sa.cfapps.io/api/Store/Artists";
		private const string ARTIST_URL = "https://musicstore-sa.cfapps.io/api/Store/Artist";
