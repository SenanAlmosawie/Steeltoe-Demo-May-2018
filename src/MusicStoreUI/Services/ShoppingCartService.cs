...
namespace MusicStoreUI.Services
{
    ...
    {
		private const string SHOPPINGCART_URL = "http://shoppingcart-sa.cfapps.io/api/ShoppingCart/{cartId}";
		private const string SHOPPINGCART_ITEM_URL ="http://shoppingcart-sa.cfapps.io/api/ShoppingCart/{cartId}/Item/{itemId}";
